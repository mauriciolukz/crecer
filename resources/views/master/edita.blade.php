            ...
            <div class="panel panel-default">
              ...
              @endif
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" method="POST" action="{{route('guarda')}}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input id="directo" type="text" class="form-control" name="directo" value="{{ $patrocinador->nombre }} {{ $patrocinador->apellidoPaterno }} {{ $patrocinador->apellidoMaterno }}" oninvalid="this.setCustomValidity('Por favor rellene este campo')" disabled>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <label for="directo" class="col-md-2">Si no selecciona uno se asignara a Master</label> --> 
